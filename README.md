...
### 管理者機能（admin/admin でログイン）
- ✅ メンバー管理（登録、削除、チーム割り当て：A～J の10チーム）
- ✅ 評価項目管理（登録、削除、変更、表示順設定）
...
- `POST /api/items` - 評価項目追加（管理者専用、body: name, description, display_order）
- `PUT /api/items/:id` - 評価項目更新（管理者専用）
